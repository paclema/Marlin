...
#define STRING_CONFIG_H_AUTHOR "(paclema, witbox unofficial config with bqCNC)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BQCNC
#endif
...
#define DEFAULT_MAX_FEEDRATE          {350, 350, 40, 80}    // (mm/sec)
